...
export class FileAnalysisController {
  ...
  @ApiOperation({
    ...
    description:
      'Upload a PDF, JPEG, PNG, or WebP file for AI analysis. The AI will analyze the content and provide insights. Optionally provide a custom prompt for specific analysis.',
  })
