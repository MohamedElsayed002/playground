...
export class AiAgentService {
    ...
    async handleCustomerQuery(query: string) {
        ...
        const { text: response } = await generateText({
            ...
            system: {
                ...
                refund: "You are customer service agent specializing in refund requests. Follow company policy and collect necessary information",
    ...
    async parallelCodeReview(code: string) {
        ...
        const [securityReview, performanceReview, maintainabilityReview] = await Promise.all([
            ...
            generateObject({
                model,
                system: "You are expert in code performance. Focus in identifying performance bottlenecks, memory leaks, and optimization opportunities.",
                schema: z.object({
    ...
    async implementFeature(featureRequest: string) {
        const { object: implementationPlan} = await generateObject({
            ...
            system: "You are a senior software architecht planning feature implementations.",
