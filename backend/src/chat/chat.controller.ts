...
export class ChatController {
  ...
  @ApiOperation({
    ...
    description:
      'Send a message to the AI chat. Supports web search grounding, custom models, temperature control, and thinking budget configuration.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Get a streaming response from the AI chat. Returns Server-Sent Events (SSE) with incremental text chunks.',
  })
  @ApiBody({ type: ChatRequestDto })
  @ApiResponse({
    status: 200,
