...
export interface paths {
    ...
    "/api/v1/auth/logout": {
        ...
        /**
         * Logout current user
         * @description Log the current user out and record audit events.
         */
    ...
    "/api/v1/files/pdf/status/{file_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/audit-logs/": {
        ...
        /** Audit Logs List */
        get: operations["audit_logs_list_api_v1_audit_logs__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/audit-logs/{log_id}": {
        ...
        /**
         * Audit Log By Id
         * @description [Admin] Fetch a single audit log entry by ID.
         */
        get: operations["audit_log_by_id_api_v1_audit_logs__log_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        PDFExtractResponse: {
            ...
            /** Full Text */
            full_text: string;
            structured_data?: components["schemas"]["CVStructuredData"] | null;
        };
        /** PDFPageContent */
        PDFPageContent: {
            /** Page Number */
...
export interface operations {
    ...
    extract_pdf_authenticated_api_v1_files_pdf_extract_authenticated_post: {
        parameters: {
            query?: never;
            header?: {
                /** @description Unique identifier for request idempotency.Same key = cached response, prevents duplicate processing. Optional - if not provided, UUID will be auto-generated */
        ...
        requestBody: {
            content: {
                "multipart/form-data": components["schemas"]["Body_extract_pdf_authenticated_api_v1_files_pdf_extract_authenticated_post"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    get_pdf_status_api_v1_files_pdf_status__file_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    audit_logs_list_api_v1_audit_logs__get: {
        parameters: {
            query?: {
                page?: number;
                page_size?: number;
    ...
    audit_log_by_id_api_v1_audit_logs__log_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
