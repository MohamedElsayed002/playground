    ...
    <main className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <section className="rounded-2xl border bg-linear-to-b from-zinc-50 to-white p-8 shadow-sm dark:from-zinc-950 dark:to-zinc-950/60">
        ...
        <p className="mt-3 max-w-3xl text-pretty text-base leading-relaxed text-zinc-700 dark:text-zinc-300">
          ...
          <span className="font-medium">Job Application Tailor</span>. I built it to turn “prompt →
          real output” into a reliable pipeline: audio, PDFs, and a cover image — with safe retries
          when something fails.
        </p>
        <p className="mt-3 max-w-3xl text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
          The platform follows a SaaS model with <span className="font-medium">Better Auth</span>{" "}
          for secure access,
          <span className="font-medium"> Polar</span> for payments, and premium features for Pro
          members.
        </p>
          ...
          <ul className="mt-4 space-y-3 text-sm text-zinc-700 dark:text-zinc-300">
            <li className="flex gap-3">
              ...
              <span>
                ...
                : debate-style structure, readable PDFs, and a cover image that fits the topic.
              </span>
            </li>
            <li className="flex gap-3">
              <span className="mt-1 inline-block size-2 rounded-full bg-zinc-900 dark:bg-zinc-100" />
              <span>
                <span className="font-medium text-zinc-900 dark:text-zinc-100">Reliability</span>:
                background jobs with retries so partial failures don’t ruin the whole generation.
              </span>
            </li>
            <li className="flex gap-3">
              <span className="mt-1 inline-block size-2 rounded-full bg-zinc-900 dark:bg-zinc-100" />
              <span>
                <span className="font-medium text-zinc-900 dark:text-zinc-100">Clear UX</span>:
                simple form → trackable progress → deliverables you can download and share.
              </span>
            </li>
          </ul>
        </div>
      ...
      <section className="mt-12">
        <div className="flex flex-col gap-2">
          ...
          <p className="max-w-3xl text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
            The generator runs as a pipeline. If something fails (LLM, TTS, upload, PDF), it’s
            retried{" "}
            <span className="font-medium text-zinc-900 dark:text-zinc-100">up to 3 times</span>{" "}
            using Inngest retry policies.
          </p>
        </div>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-2">
          <figure className="rounded-2xl border bg-white p-4 shadow-sm dark:bg-zinc-950">
            ...
            <figcaption className="mt-3 text-xs text-zinc-600 dark:text-zinc-400">
              High-level steps: fetch user + credentials → generate debate → optional summary →
              audio → PDF → save → notify.
            </figcaption>
          </figure>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          <div className="rounded-2xl border bg-white p-6 shadow-sm dark:bg-zinc-950">
            ...
            <p className="mt-2 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
              ...
              <span className="font-medium text-zinc-900 dark:text-zinc-100">detailed PDF</span>{" "}
              with the summary and supporting structure. If it’s a 1-minute podcast, it produces a{" "}
              <span className="font-medium text-zinc-900 dark:text-zinc-100">
                simple script PDF
              </span>{" "}
              only.
          ...
          <div className="rounded-2xl border bg-white p-6 shadow-sm dark:bg-zinc-950">
            ...
            <p className="mt-2 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
              Podcast generation touches multiple external services (LLM, TTS, image generation,
              uploads). Running this work in a job queue keeps the UI fast and makes failures
              recoverable instead of frustrating.
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-2">
          <div className="rounded-2xl border bg-white p-6 shadow-sm dark:bg-zinc-950">
            ...
            <p className="mt-2 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
              Here are two real PDFs generated by the pipeline — one for longer audio (detailed),
              and one for the 1-minute mode (script-only).
            </p>
      ...
      <section className="mt-12">
        <h2 className="text-2xl font-semibold tracking-tight text-zine-950 dark:text-zinc-50">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
          ...
          <figure className="rounded-2xl border bg-white p-4 shadow-sm dark:bg-zinc-950">
            <div className="overflow-hidden rounded-xl border bg-zinc-50 dark:bg-zinc-900">
              <Image
                src="/design-job-application.png"
                width={1400}
                height={800}
                className="h-auto w-full"
      ...
      <section className="mt-12">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
          CareerCastAI isn’t just one feature — it’s a set of focused workflows that ship real
          deliverables.
        </p>
      ...
      <section className="mt-12">
        <div className="rounded-2xl border bg-white p-7 shadow-sm dark:bg-zinc-950">
          ...
          <p className="mt-3 max-w-4xl text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
            This part came from a real pain point: getting rejected many times. I wanted an
            ATS-style signal to answer one question quickly:{" "}
            <span className="font-medium text-zinc-900 dark:text-zinc-100">
              am I a good candidate for this role?
            </span>{" "}
        ...
        <div className="rounded-2xl border bg-white p-7 shadow-sm dark:bg-zinc-950">
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            ...
            >
              ...
              <p className="mt-1 text-xs text-zinc-600 dark:text-zinc-400">Try the app on Vercel</p>
              <p className="mt-3 text-xs font-medium text-zinc-900 underline underline-offset-4 group-hover:opacity-80 dark:text-zinc-100">
                Open demo →
              </p>
            </a>
