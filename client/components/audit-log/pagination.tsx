  ...
  return (
    <div className="flex items-center justify-between px-2">
      ...
      <div className="flex items-center space-x-6 lg:space-x-8">
        ...
        <div className="flex w-[100px] items-center justify-center text-sm font-medium text-white/70">
        ...
        <div className="flex items-center space-x-2">
          <Button
            variant="outline"
            size="icon"
            className="hidden h-8 w-8 lg:flex bg-white/5 border-white/10 hover:bg-white/10 text-white"
